...
<nav class="navbar">
    <div class="logo_item">
        ...
        <div class="expand_sidebar" id="sidebarOpen">
            {{--            <img class="" src="images/e422b1d1-e9e7-4619-886c-869091f6116a.png" alt=""> --}}
    ...
    <div class="data-time">
        <p class="time">12:15:30 PM</p>
        <p class="date">MAY 18 THURSDAY</p>
    </div>
...
<div class="main">
    {{--    <img class="left-arrow" src="images/0a3b996d-fc85-405b-86f4-31f3e1641813.png" alt="">--}}
    {{--    <img class="right-arrow" src="images/4dc5a9b3-2f19-4f07-bb91-d47ba4c26760.png" alt="">--}}
    {{--    <img class="block-1" src="images/7a440a85-5b42-419d-9ccc-fb39f31b57d5.png" alt="">--}}
    {{--    <img class="car-1" src="images/42cd8f47-ae12-474b-933b-40ad4b367db4.png" alt="">--}}
